...
import { createMeetingNote } from "@/lib/actions/meeting-notes"
import type { CreateMeetingNoteInput } from "@/lib/types/meeting-notes"
...
export function CreateMeetingNoteDialog({ open, onOpenChange }: CreateMeetingNoteDialogProps) {
  ...
  const createMutation = useMutation({
    ...
    onError: (error: Error) => {
      toast.error("Failed to create meeting note", { description: error.message })
    },
  })
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const input: CreateMeetingNoteInput = {
      title: title.trim(),
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>Create a new meeting note with details and attendees.</DialogDescription>
        </DialogHeader>
